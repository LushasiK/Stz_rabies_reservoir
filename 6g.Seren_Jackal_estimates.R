## In this code we are looking at calculating jackal densities for Serengeti. 
...
Cell_data <- read.csv("output/Seren_CellData4kmsq.csv")
HP <- read.csv("output/SerenHumanPopMat_Cell.csv", header = F)
...
Area_out_above5_below2000 <- length(which(HP$V1<2000 & HP$V1 >5))*4
...
## Area for Serengeti taken from the info provided by Katie 
## and also caclulated in "Calculatenon_protected_areas_Seren_Ngoro"
...
# write.csv(JD_cutoff2000, "Output/Serengeti_Jackal_number_estimates_cutoff2000percell.csv")
# write.csv(JD_cutoff_0_2000, "Output/Serengeti_Jackal_number_est_above_0_below_2000_percell.csv")
# write.csv(JD_cutoff_1_2000, "Output/Serengeti_Jackal_number_est_above_1_below_2000_percell.csv")
# write.csv(JD_cutoff_5_2000, "Output/Serengeti_Jackal_number_est_above_5_below_2000_percell.csv")
# write.csv(JD_cutoff_10_2000, "Output/Serengeti_Jackal_number_est_above_10_below_2000_percell.csv")
# write.csv(JD_cutoff_20_2000, "Output/Serengeti_Jackal_number_est_above_20_below_2000_percell.csv")
